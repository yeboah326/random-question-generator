...
pass_file_names = {"1": "./questions/eng_econs_1.json", "2":"./questions/dsp_end_of_sem.json", "3":"./questions/eng_econs_2015.json", "4": "./questions/management_1.json"}

if __name__ == "__main__":
    system("cls|clear")

    print("""
            Select a set of questions to go through: 
